 ...
 *
 * (c) Copyright 1996-2002, Measurement Computing Corp.
 * All rights reserved.
 *
...
#define BADRATE            24   /* Invalid sampling rate specified */
#define COMPATMODE         25   /* Board switches set for "compatible" mode */
#define TRIGSTATE          26   /* Incorrect initial trigger state D0 must=TTL low) */
...
#define FILTER_           0x0000    /* Filter thermocouple inputs */
