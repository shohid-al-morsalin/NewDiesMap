/*****************************************************************************
*
* Copyright (c) 2002-2009 Lumenera Corporation. All rights reserved.
*
*****************************************************************************/
...
LUCAM_API BOOL LUCAM_EXPORT LucamOneShotAutoExposureEx(HANDLE hCamera, UCHAR target, ULONG startX, ULONG startY, ULONG width, ULONG height, float lightingFrequency);
...
//-----------------------------------------------------------------------------
// GEV specific cameras functionnalities
//-----------------------------------------------------------------------------

LUCAM_API BOOL LUCAM_EXPORT LucamSelectExternInterface(ULONG externInterface); // The API defaults to USB

typedef struct _LGCAM_IP_CONFIGURATION
{
   ULONG IPAddress;
   ULONG SubnetMask;
   ULONG DefaultGateway;
}LGCAM_IP_CONFIGURATION, *PLGCAM_IP_CONFIGURATION;
...
//-----------------------------------------------------------------------------
// End of GEV specific cameras functionnalities
//-----------------------------------------------------------------------------
