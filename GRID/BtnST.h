...
// Comment this if you don't want to use CMmDC class
#define ST_USE_MEMDC
...
public:
	...
	CMmDC* operator->() { return this; }

	// Allow usage as a pointer
	operator CMmDC* () { return this; }

private:
	CBitmap  m_bitmap;      // Offscreen bitmap
	CBitmap* m_pOldBitmap;  // bitmap originally found in CMmDC
