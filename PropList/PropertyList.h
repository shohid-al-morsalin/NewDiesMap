...
#define PIT_XYPOINT		14	//Hot Key	Temporarily unavailable
...
class CPropertyItem {
public:
	BOOL IsProp(CString str);
	BOOL IsCatalog(CString str);
	CString m_catalog;
	CString m_propName;
	CString m_curValue;
	CString m_cmbItems;
...
public:
	...
	BOOL AddPropItem(CString catalog, CString propName, CString curValue, int nItemType, CString cmbItems, CString propDesc = "");
